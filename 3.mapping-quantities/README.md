...
Open a terminal window in your main `di-2021` folder via the Github Desktop app’s **Repository → Open in Terminal** menu. Once there, type `make server`. You'll then see a message along the lines of:
...
Examine the [`data`](https://github.com/samizdatco/di-2021/tree/master/3.mapping-quantities/data) subdirectory of the project folder which contains JSON & CSV versions of the table below. Then look at the scripts in the [`examples`](https://github.com/samizdatco/di-2021/tree/master/3.mapping-quantities/examples) folder. These scripts build on our work learning the p5 drawing primitives in three major ways:
...
I've assembled a cleaned-up [csv file](https://github.com/samizdatco/di-2021/tree/master/3.mapping-quantities/data/johnstons-archive.csv) with most of the Johnston's Archive data. If you're looking for information about the naming schemes of the individual tests, yield estimates, locations, dates, etc. it may be helpful...
